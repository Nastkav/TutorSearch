...
public class SolutionController : Controller
{
    ...
    {
        var templateDbContext = _context.Solutions.Include(s => s.Student).Include(s => s.Assignment);
    ...
    public async Task<IActionResult> Details(int? id)
    {
        ...
        if (solutionModel == null) return NotFound();
    ...
    public async Task<IActionResult> Create(
        [Bind("Id,TaskId,StudentId,Answer,CreatedAt,UpdatedAt")]
        SolutionModel solutionModel)
    {
        ...
        ViewData["TaskId"] = new SelectList(_context.Tasks, "Id", "Description", solutionModel.AssignmentId);
        return View(solutionModel);
    }
    ...
    public async Task<IActionResult> Edit(int id,
        ...
        SolutionModel solutionModel)
    {
        if (id != solutionModel.Id) return NotFound();
    ...
    {
        var solutionModel = await _context.Solutions.FindAsync(id);
        if (solutionModel != null) _context.Solutions.Remove(solutionModel);

        await _context.SaveChangesAsync();
        return RedirectToAction(nameof(Index));
    }

    private bool SolutionModelExists(int id) => _context.Solutions.Any(e => e.Id == id);
}
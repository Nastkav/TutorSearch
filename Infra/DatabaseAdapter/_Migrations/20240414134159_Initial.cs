        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseModelId = table.Column<Guid>(type: "char(36)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TutorProfiles_AspNetUsers_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AvailableTime_TutorProfiles_ProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteTutor", x => new { x.UserModelId, x.TutorProfileId });
                    table.ForeignKey(
                        name: "FK_FavoriteTutor_AspNetUsers_UserModelId",
                        column: x => x.UserModelId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FavoriteTutor_TutorProfiles_TutorProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubjectModelTutorProfile", x => new { x.ProfilesId, x.SubjectsId });
                    table.ForeignKey(
                        name: "FK_SubjectModelTutorProfile_Subjects_SubjectsId",
                        column: x => x.SubjectsId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubjectModelTutorProfile_TutorProfiles_ProfilesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonModelUserModel", x => new { x.LessonsId, x.StudentsId });
                    table.ForeignKey(
                        name: "FK_LessonModelUserModel_AspNetUsers_StudentsId",
                        column: x => x.StudentsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LessonModelUserModel_Lessons_LessonsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Solutions_AspNetUsers_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Solutions_Tasks_TaskModelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailableTime_ProfileId",
                table: "AvailableTime",
                column: "ProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonModelUserModel_StudentsId",
                table: "LessonModelUserModel",
                column: "StudentsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Solutions_TaskModelId",
                table: "Solutions",
                column: "TaskModelId");

            migrationBuilder.CreateIndex(
                name: "IX_SubjectModelTutorProfile_SubjectsId",
                table: "SubjectModelTutorProfile",
                column: "SubjectsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TutorProfiles_CreatedBy",
                table: "TutorProfiles",
                column: "CreatedBy");

            migrationBuilder.AddForeignKey(
                name: "FK_AboutTutor_TutorProfiles_ProfileId",
                table: "AboutTutor",
                column: "ProfileId",
                principalTable: "TutorProfiles",
                principalColumn: "Id",
